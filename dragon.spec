...
Version  : 22.04.1
Release  : 41
URL      : https://download.kde.org/stable/release-service/22.04.1/src/dragon-22.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.04.1/src/dragon-22.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.1/src/dragon-22.04.1.tar.xz.sig
...
%prep
%setup -q -n dragon-22.04.1
cd %{_builddir}/dragon-22.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652645717
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/dragon-22.04.1/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/dragon/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/dragon-22.04.1/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/dragon/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/dragon-22.04.1/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/dragon/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/dragon-22.04.1/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/dragon/6091db0aead0d90182b93d3c0d09ba93d188f907
cp %{_builddir}/dragon-22.04.1/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/dragon/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/dragon-22.04.1/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/dragon/7d9831e05094ce723947d729c2a46a09d6e90275
pushd clr-build
%make_install
popd
