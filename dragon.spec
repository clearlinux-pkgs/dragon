...
Source0  : https://download.kde.org/stable/release-service/20.04.2/src/dragon-20.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.04.2/src/dragon-20.04.2.tar.xz.sig
...
%prep
%setup -q -n dragon-20.04.2
cd %{_builddir}/dragon-20.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591902167
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/dragon-20.04.2/COPYING %{buildroot}/usr/share/package-licenses/dragon/0b184ad51ba2a79e85d2288d5fcf8a1ea0481ea4
cp %{_builddir}/dragon-20.04.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/dragon/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
pushd clr-build
%make_install
popd
